    ...
    "inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2 py-0.5 text-xs font-medium whitespace-nowrap transition-[color,box-shadow] focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3",
    {
        variants: {
            variant: {
                ...
                sourceActionStatus:
                    "h-auto gap-1.5 border-0 bg-transparent p-0 text-muted-foreground data-[sot-state=saved]:text-primary data-[sot-state=saving]:text-primary data-[sot-state=error]:text-destructive [&_[data-sot-part=source-action-status-indicator]]:size-2 [&_[data-sot-part=source-action-status-indicator]]:rounded-full [&_[data-sot-part=source-action-status-indicator]]:bg-secondary-foreground/45 data-[sot-state=saved]:[&_[data-sot-part=source-action-status-indicator]]:bg-primary data-[sot-state=saving]:[&_[data-sot-part=source-action-status-indicator]]:animate-pulse data-[sot-state=saving]:[&_[data-sot-part=source-action-status-indicator]]:bg-primary data-[sot-state=error]:[&_[data-sot-part=source-action-status-indicator]]:bg-destructive",
                settingsSaveStatus:
