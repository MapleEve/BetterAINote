...
export const SOURCE_REPORT_CARD_VALUE_CLASS_NAME =
    "![font:600_13px_var(--font-sans)] leading-[normal] tracking-normal text-[var(--fg-primary)]";

export const SOURCE_REPORT_CARD_SOURCE_VALUE_CLASS_NAME =
    "flex items-center gap-[6px]";

export const SOURCE_REPORT_CARD_NUMBER_VALUE_CLASS_NAME =
    "![font:600_16px_var(--font-mono)] text-[var(--fg-primary)]";
...
export const SOURCE_REPORT_SECTION_CLASS_NAME =
    "flex flex-col gap-[8px] border-t border-[var(--glass-border-soft)] pt-[8px]";
...
export const SOURCE_REPORT_SEGMENT_TEXT_CLASS_NAME =
    "m-0 ![font:500_12.5px/1.55_var(--font-sans)] ![color:var(--fg-primary)] [text-wrap:pretty]";
...
export const SOURCE_REPORT_META_ROW_CLASS_NAME =
    "grid min-h-[30px] grid-cols-[80px_1fr] items-baseline gap-[8px] border-b border-dashed border-[var(--glass-border-soft)] py-[6px]";
...
export const SOURCE_REPORT_EMPTY_TITLE_CLASS_NAME =
    "m-0 block min-h-0 overflow-visible ![font:600_13px/1.35_var(--font-sans)] tracking-normal text-[var(--fg-primary)]";
