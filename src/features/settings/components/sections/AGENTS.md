# src/features/settings/components/sections 分层指南

## 目录职责
各设置分区 UI，覆盖数据源、显示、播放、同步、标题、转写、VoScript。

## 真实文件
- `data-sources-section.tsx`
- `display-section.tsx`
- `misc-section.tsx`
- `playback-section.tsx`
- `speaker-profiles-panel.tsx`
- `sync-section.tsx`
- `title-generation-section.tsx`
- `transcription-section.tsx`
- `voscript-section.tsx`
...
## 内层覆盖条件
- 本文件只在 `src/features/settings/components/sections/` 及其子目录内生效，子目录 AGENTS.md 可以收紧规则。
