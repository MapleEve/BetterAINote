# src/features/recordings/components 分层指南

## 目录职责
录音详情组件，处理播放、标签、来源报告、说话人编辑和转写展示。
...
## 内层覆盖条件
- 本文件只在 `src/features/recordings/components/` 及其子目录内生效，子目录 AGENTS.md 可以收紧规则。
