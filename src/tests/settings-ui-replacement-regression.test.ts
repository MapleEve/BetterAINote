...
describe("settings UI replacement S6-S8 regressions", () => {
    ...
    it("keeps VoScript and speaker profile rows renderable without expanding into later source detail work", () => {
        ...
        expect(voscript).toContain("handleSave");
        expect(voscript).toContain("handleTestConnection");
        expect(voscript).toContain("aria-busy={isSaving}");
        expect(voscript).toContain("aria-busy={isConnectionTestBusy}");
        expect(voscript).toContain("toast.success");
        expect(voscript).toContain("toast.error");
        ...
        expect(voscript).toContain('data-testid="voscript-save"');
        ...
        expect(speakers).toContain("glass-control");
        expect(speakers).not.toContain("bg-background/25");
        expect(speakers).not.toContain("bg-background/35");
        expect(speakers).not.toContain("bg-background/45");
        ...
        expect(speakers).toContain('data-testid="speaker-profiles-refresh"');
        expect(speakers).toContain('data-testid="voiceprints-refresh"');
        ...
        expect(speakers).toContain("const confirmed = await confirm");
        expect(speakers).toContain("confirmLabel");
        expect(speakers).toContain('aria-busy={localSavingId === "new"}');
        expect(speakers).toContain("aria-busy={isProfileSaving}");
        expect(speakers).toContain("aria-busy={isVoiceprintSaving}");
