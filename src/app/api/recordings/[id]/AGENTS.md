# src/app/api/recordings/[id] 分层指南

## 目录职责
单条录音 API，所有操作必须先验证归属。

## 真实文件
- `route.ts`

## 下级入口
- `src/app/api/recordings/[id]/audio/`
- `src/app/api/recordings/[id]/rename/`
- `src/app/api/recordings/[id]/source-report/`
- `src/app/api/recordings/[id]/speaker-map/`
- `src/app/api/recordings/[id]/speakers/`
- `src/app/api/recordings/[id]/tags/`
- `src/app/api/recordings/[id]/transcribe/`
- `src/app/api/recordings/[id]/transcript/`
...
## 内层覆盖条件
- 本文件只在 `src/app/api/recordings/[id]/` 及其子目录内生效，子目录 AGENTS.md 可以收紧规则。
