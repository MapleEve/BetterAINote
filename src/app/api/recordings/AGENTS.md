# src/app/api/recordings 分层指南

## 目录职责
录音集合 API，处理列表、新建、查询入口和鉴权边界。

## 真实文件
- `route.ts`

## 下级入口
- `src/app/api/recordings/[id]/`
- `src/app/api/recordings/query/`
...
## 内层覆盖条件
- 本文件只在 `src/app/api/recordings/` 及其子目录内生效，子目录 AGENTS.md 可以收紧规则。
