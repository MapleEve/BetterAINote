...
export async function GET(request: Request) {
    try {
        ...
        const settings = await getVoScriptSettingsStateForUser(userId);
        return NextResponse.json(settings);
    } catch (error) {
        console.error("Error fetching VoScript settings:", error);
        return NextResponse.json(
...
export async function PUT(request: Request) {
    try {
        ...
        await saveVoScriptSettingsForUser(userId, body);
        ...
        console.error("Error updating VoScript settings:", error);
        return NextResponse.json(
