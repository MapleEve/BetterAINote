...
export const sourceConnections = sqliteTable(
    "source_connections",
    {
        ...
        lastSyncStartedAt: timestampMs("last_sync_started_at"),
        lastSyncFinishedAt: timestampMs("last_sync_finished_at"),
        createdAt: timestampMs("created_at").notNull().defaultNow(),
        updatedAt: timestampMs("updated_at").notNull().defaultNow(),
    },
    (table) => ({
...
export const userSettings = sqliteTable("user_settings", {
    ...
    displayDensity: text("display_density").notNull().default("comfy"),
