# src/db/migrations/library 分层指南

## 目录职责
录音库迁移，覆盖 recordings、tags、来源关系。

## 真实文件
- `0000_library_baseline.sql`

## 下级入口
- `src/db/migrations/library/meta/`
...
## 内层覆盖条件
- 本文件只在 `src/db/migrations/library/` 及其子目录内生效，子目录 AGENTS.md 可以收紧规则。
