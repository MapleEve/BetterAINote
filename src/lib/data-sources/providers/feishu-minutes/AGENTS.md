# src/lib/data-sources/providers/feishu-minutes 分层指南

## 目录职责
Feishu Minutes 数据源 provider。
...
## 内层覆盖条件
- 本文件只在 `src/lib/data-sources/providers/feishu-minutes/` 及其子目录内生效，子目录 AGENTS.md 可以收紧规则。
