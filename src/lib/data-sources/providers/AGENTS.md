# src/lib/data-sources/providers 分层指南
...
## 下级入口
- `src/lib/data-sources/providers/dingtalk-a1/`
- `src/lib/data-sources/providers/feishu-minutes/`
- `src/lib/data-sources/providers/iflyrec/`
- `src/lib/data-sources/providers/plaud/`
- `src/lib/data-sources/providers/ticnote/`
...
## 内层覆盖条件
- 本文件只在 `src/lib/data-sources/providers/` 及其子目录内生效，子目录 AGENTS.md 可以收紧规则。
