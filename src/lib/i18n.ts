...
export const translations: Record<UiLanguage, TranslationTree> = {
    "zh-CN": {
        ...
        librarySearch: {
            ...
            noQuery: "输入关键字搜索录音、逐字稿片段、说话人或标签",
            error: "检索失败，请稍后重试。",
            retry: "重试",
            resultsLabel: "搜索结果",
        ...
        activityOverlay: {
            title: "最近动态",
            open: "打开最近动态",
            openWithPending: "打开最近动态，{count} 项待处理",
            close: "关闭最近动态",
    ...
    en: {
        ...
        activityOverlay: {
            ...
            open: "Open recent activity",
            openWithPending: "Open recent activity, {count} pending",
