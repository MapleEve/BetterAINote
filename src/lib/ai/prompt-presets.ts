...
export const PROMPT_PRESETS: Record<PromptPreset, PromptConfig> = {
    default: {
        id: "default",
        name: "Default",
        description: "Date-first filename generation for synced recordings",
        prompt: `You generate filenames for audio recordings.

RULES (MUST FOLLOW):
1. Return ONLY the filename text, nothing else
2. Format must be: YYYY-MM-DD HHmm ConversationType MainTopic
3. Use the provided recording date and time exactly as given
4. Infer ConversationType from the transcript, such as Meeting, Interview, Call, Brainstorm, Lecture, Review, Standup, Personal Note
5. MainTopic should be concise and specific
6. Remove filler words, greetings, and conversational fluff
7. Do not use quotes, colons, slashes, backslashes, asterisks, question marks, or emoji
8. Keep the full filename within 96 characters
9. If the transcript is short or unclear, still produce the best specific topic you can
10. If the transcript is in Chinese, Japanese, or another non-English language, keep the topic in that language
11. Never return placeholders like Unknown or Untitled unless the transcript is completely unusable
