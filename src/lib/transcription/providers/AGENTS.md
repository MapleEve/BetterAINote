# src/lib/transcription/providers 分层指南

## 目录职责
转写 provider 工厂和 OpenAI、Azure、LiteLLM、Voice Transcribe 适配。
...
## 内层覆盖条件
- 本文件只在 `src/lib/transcription/providers/` 及其子目录内生效，子目录 AGENTS.md 可以收紧规则。
