...
重点は、1 社のサービスではなく、複数プラットフォームの音声資料を私有環境で集約し、統一管理することです。<br>
...
[Quickstart](#はじめかた) · [AI install/deploy](./docs/AI_INSTALL_DEPLOYMENT.md) · [Data sources](./docs/DATA_SOURCES.md) · [API](./docs/API.md) · [Deployment](./docs/DEPLOYMENT.md) · [Privacy](./docs/PRIVACY.md)
...
| トピック | 简体中文 default | English | 日本語 | 한국어 |
| --- | --- | --- | --- | --- |
| 概要 | [README.md](./README.md) | [README.en.md](./README.en.md) | [README.ja.md](./README.ja.md) | [README.ko.md](./README.ko.md) |
